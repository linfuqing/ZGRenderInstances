...
namespace ZG
{
    ...
    public partial struct InstanceSystemUnmanaged : ISystem
    {
        private struct Save
        {
            ...
            [ReadOnly] public BufferAccessor<InstancePrefab> prefabs;
        ...
        {
            [ReadOnly] public ComponentTypeHandle<CopyMatrixToTransformInstanceID> idType;

            [ReadOnly] public BufferTypeHandle<InstancePrefab> prefabType;
        ...
        private struct CollectEx : IJobChunk
        {
            ...
            [ReadOnly] public ComponentTypeHandle<Instance> instanceType;
        ...
        public void OnCreate(ref SystemState state)
        {
            ...
            __entityPrefabReferences =
                new NativeParallelMultiHashMap<int, EntityPrefabReference>(1, Allocator.Persistent);
