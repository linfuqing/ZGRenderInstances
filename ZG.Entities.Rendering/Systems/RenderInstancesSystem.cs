...
namespace ZG
{
        ...
        private struct Comparer : IComparer<ArchetypeChunk>
        {
            ...
            public int Compare(ArchetypeChunk x, ArchetypeChunk y)
            {
                ...
                if (sortingOrderX == sortingOrderY)
                    return x.GetSharedComponentIndex(sharedDataType)
                        .CompareTo(y.GetSharedComponentIndex(sharedDataType));
    ...
    public abstract partial class RenderInstancesSystem<T> : SystemBase where T : unmanaged, IComponentData
    {
        ...
        private struct DidChange : IJobChunk
        {
            ...
            [ReadOnly] public SharedComponentTypeHandle<RenderSharedData> sharedDataType;

            [ReadOnly] public ComponentTypeHandle<RenderSortingOrder> sortingOrderType;

            [ReadOnly] public ComponentTypeHandle<T> instanceDataType;
        ...
        public abstract int constantBufferID { get; }
        ...
        protected override void OnUpdate()
        {
            ...
            __Render(__staticCommandBuffer, __staticGroup, ref __staticVersion);
            __Render(__dynamicCommandBuffer, __dynamicGroup, ref __dynamicVersion);
        }

        private void __Render(CommandBuffer commandBuffer, in EntityQuery group, ref uint version)
        {
