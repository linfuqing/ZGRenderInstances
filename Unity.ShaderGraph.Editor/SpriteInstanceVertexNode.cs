...
{
    [Title("Input", "2D", "Sprite Instance Vertex Node")]
    class SpriteInstanceVertexNode : AbstractMaterialNode, 
        IGeneratesBodyCode, 
        IGeneratesFunction, 
        //IMayRequireMeshUV, 
        IMayRequirePosition
    {
        ...
        public SpriteInstanceVertexNode()
        {
            name = "Sprite Instance Vertex Node";
