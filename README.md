...
有的时候你可能希望同时用SkinnedMeshRendererAuthoring和UnityEngine.Animator来渲染不同的怪物，比如大批次的小怪使用SkinnedMeshRendererAuthoring来进行Instance优化，而BOSS使用UnityEngine.Animator来保证动画混合及灵活度。
